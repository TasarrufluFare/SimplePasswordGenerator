...
def create_list(given_parameters_list, given_char_count_min, given_char_count_max, password_count):
    ...
    for member in given_parameters_list:
        ...
        if member == "4" and not numbers_added:
...
def usr_input_check(given_input):
    if given_input == "Exit" or given_input == "Quit" or given_input == "5" or given_input == "-q":
        print("See you soon")
        time.sleep(1.5)
        exit()
    ...
    if re.search("^-create ", given_input):
        ...
        if len(given_command_list) != 5:
            if len(given_command_list) == 4:
                ...
                print("Example usage: -create 1+2+3+4 15 25 1")
                exit()
...
print("4 - Contains Digits")
print("5 - Exit")
print("--------------------------------")

print("\n-------------HELP---------------")
print("Usage: -create {Parameters} {Min Char Count} {Mix Char Count} {Password Count}")
print("\nExample usage: -create 1+2+3+4 15 25 1\n")
print("Example output: TVdsE]pe;S8]B<Vzf")
print("--------------------------------")
